  ...
  fields: {
    operator: {
      validate: !process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.assertValueType)("string") : Object.assign(function () {
        var identifier = (0, _utils.assertOneOf).apply(void 0, _toConsumableArray(_index.ASSIGNMENT_OPERATORS));
...
defineType("BinaryExpression", {
  ...
  fields: {
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, _toConsumableArray(_index.BINARY_OPERATORS))
    },
    left: {
      validate: function () {
...
defineType("LogicalExpression", {
  ...
  fields: {
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, _toConsumableArray(_index.LOGICAL_OPERATORS))
    },
    left: {
      validate: (0, _utils.assertNodeType)("Expression")
    },
...
defineType("UnaryExpression", {
  ...
  fields: {
    ...
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, _toConsumableArray(_index.UNARY_OPERATORS))
    }
  },
  visitor: ["argument"],
...
defineType("UpdateExpression", {
  ...
  fields: {
    ...
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, _toConsumableArray(_index.UPDATE_OPERATORS))
    }
  },
  visitor: ["argument"],
  aliases: ["Expression"]
